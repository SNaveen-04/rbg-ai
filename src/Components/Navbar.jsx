  ...
  return (
    ...
    <nav className={`${colour} md:mb-0 flex flex-col text-white`}>
        <div className="flex justify-between items-center py-2 px-6 border-0 border-b border-solid border-white">
            ...
            <Hamburger easing="ease-in" rounded size={20} toggled={showMenu} toggle={setShowMenu} />
            </span>
    ...
    <nav className={`${colour} w-2/3 h-screen md:hidden flex flex-col absolute text-white border-0  border-r border-solid border-white transition-all duration-500 ease-in-out`+ (showMenu ? ' -left-0' : ' -left-full')}>
