...
export default function Content() {
  return (
    <div className="min-h-screen flex-col bg-red-400 py-10 w-full max-w-full flex items-center sm:px-5 lg:px-20 md:px-10 justify-center">
      ...
      <ul className="grid md:grid-cols-2">
        {courseContent.map((item, index) => (
          <li
            ...
            key={index}
          >
            <p className="font-semibold  text-red-400 text-lg mb-5">
              Day
              <span
