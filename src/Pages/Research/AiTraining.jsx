...
const AiTraining = () => {
  return (
    <div className=" font-Sans text-center h-auto m-4 py-8 my-10 mx-8 xl:mx-20 2xl:mx-16 max-md:mx-4 p-2 bg-Primary rounded text-Secondary shadow-sm  shadow-slate-400">
      ...
      <div className="flex justify-evenly items-center max-md:flex-col">
        ...
        <div className="flex flex-col p-6 justify-between items-center">
          ...
          <a href="https://github.com/rbg-research/AI-Training" className="border border-white hover:bg-Secondary  hover:text-Primary  m-2 p-2 duration-150 rounded-3xl">KNOW MORE</a>
